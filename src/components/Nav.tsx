...
type GetProvidersType = Record<LiteralUnion<BuiltInProviderType, string>, ClientSafeProvider> | null;
  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
      <Link href="/" className="gap-2 flex-center">
        <Image
          src="/assets/images/logo.svg" /* đường dẫn trong public sau khi build */
          alt={'Promptopia Logo'}
          width={30}
          height={30}
